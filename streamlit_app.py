...
def load_model():
    model = tf.keras.models.load_model('C:\\Users\\Mahesh Kumar\\Desktop\\image project\\breast_cancer_classification-_img\\pppppppppppppppppmodel.h5')  # Ensure this file is in the same directory
    return model
